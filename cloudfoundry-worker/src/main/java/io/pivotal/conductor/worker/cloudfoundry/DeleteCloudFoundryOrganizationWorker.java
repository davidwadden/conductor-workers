...
public class DeleteCloudFoundryOrganizationWorker implements Worker {

    static final String TASK_DEF_NAME = "delete_cloud_foundry_organization";

    private final CloudFoundryOrganizationClient organizationClient;

    public DeleteCloudFoundryOrganizationWorker(
    ...
    public TaskResult execute(Task task) {
        ...
        if (!dryRun) {
            organizationClient.deleteOrganization(foundationName, organizationName);
        }
