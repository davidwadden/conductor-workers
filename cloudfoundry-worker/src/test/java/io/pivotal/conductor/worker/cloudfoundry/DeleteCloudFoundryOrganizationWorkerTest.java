...
class DeleteCloudFoundryOrganizationWorkerTest {

    @Mock
    private CloudFoundryOrganizationClient mockCloudFoundryOrganizationClient;
    private DeleteCloudFoundryOrganizationWorker worker;

    @BeforeEach
    void setUp() {
        worker = new DeleteCloudFoundryOrganizationWorker(
    ...
    void execute() {
        ...
        verify(mockCloudFoundryOrganizationClient)
            .deleteOrganization("some-foundation-name", "some-organization-name");
