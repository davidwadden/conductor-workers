...
class UnpauseConcoursePipelineWorkerTest {

    private ConcourseProperties properties;
    private MockRestServiceServer mockServer;
    private UnpauseConcoursePipelineWorker worker;
    ...
    void setUp() {
        ...
        worker = new UnpauseConcoursePipelineWorker(properties, restTemplate);
    }
    ...
    void execute() {
        ...
        String requestUrl =
            String.format("%s/api/v1/teams/%s/pipelines/some-project-name/unpause",
